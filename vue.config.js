...
const CompressionPlugin = require('compression-webpack-plugin') //npm install compression-webpack-plugin@5.0.1 --save-dev插件需要npm安装（不要安装最新版本7.0）
...
module.exports = {
    ...
    chainWebpack: (config) => {
        ...
        config.resolve.alias
            ...
            .set('vuejs-datatable', resolve('vuejs-datatable / dist / vuejs-datatable.esm.js'))
    },
